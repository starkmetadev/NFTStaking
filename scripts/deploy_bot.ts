...
async function main() {
  ...
  // const Lockup = await factory2.deploy("0x1f3fa5ba82ecfe38eb16d522377807bc0f8c8519", contract.address, "0xaaf9591d9e62acb8061599671f3788a875ced8d9")
  // await Lockup.deployed()
  // console.log("Lockup address",Lockup.address)

  // let tx = await contract.transferOwnership(Lockup.address)
  // await tx.wait()
